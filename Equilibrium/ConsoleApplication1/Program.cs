...
namespace ConsoleApplication1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //WriteLine("Zip : {0}", (new Zip()).solution(100000000, 100000000));
            WriteLine("Zip2: {0}", (new Zip()).solution2(1234, 567890));
            WriteLine("Whole Square Count : {0}", (new SquareCount()).solution(0, 2147483647));
            WriteLine("gaps: {0}", (new BinaryGap()).solution(20));
